...
const main = async () => {
    ...
    // Creating new instance of smart contract
    ...
    const address = '0x075e72a5eDf65F0A5f44699c7654C1a76941Ddc8';
    const balance = ethers.formatEther(await myContract.balanceOf(address));
